...
Applied economist and graduate student in Computational Analysis and Public Policy at the University of Chicago, bringing together the rigor of econometrics and the tools of modern data science. I'm drawn to questions where getting the causal story right actually matters, and where the regulatory detail matters as much as the data: property taxation, housing markets, utility regulation, public health, and crime.

Research intern at the World Bank's DECDI division, formerly DIME (Summer 2026), where I worked on satellite-imagery analysis of transit-driven urbanization in Dakar and testing Mumbai property tax records for assessment anomalies. Currently research assistant at the Mansueto Institute for Urban Innovation and previously at the Insper Cities Lab in São Paulo, where I spent two years doing empirical urban and crime economics research, mentoring students, and teaching applied econometrics and GIS.

## What I work on

- **Causal inference** — DiD, RDD, IV, staggered designs. First-author publication in *Utilities Policy*; co-authored working paper on police body cameras in progress.
...
|---|---|---|
| [NYC Property Tax Assessment](https://github.com/Rodrigofch7/nyc_property_taxes_local) · [live](https://nycpropertytaxes.streamlit.app/) | Python · Machine Learning · ETL | Horizontal-equity audit of 1.1M NYC properties. ~43% sit >15% from their peer-group median; comparable Queens homes differ ~4x in effective tax rate under the Class 1 assessment cap. I owned the labelling methodology, data pipeline, and modelling. |
| [Data Centers Next Door](https://github.com/Rodrigofch7/data-centers-urban-effects) · [live](https://rodrigofrancac.shinyapps.io/project-datacenter-urban-effects/) | Shiny · Spatial Data · Data Viz | Exploratory tool mapping how data center proximity relates to Chicago housing and household costs. Descriptive, not causal. I did the scraping, geocoding, and dashboard. |
| [Private Ownership of Water and Wastewater Systems: Assessing Health Impacts](https://www.sciencedirect.com/science/article/abs/pii/S0957178725000189?via%3Dihub) | Panel Data · DiD · Causal Inference | Sole first-author evaluation of water privatization and health across 322 Brazilian privatizations (1998-2021), via Callaway-Sant'Anna staggered DiD. Significant falls in under-five diarrheal morbidity; mixed across municipalities. Published in *Utilities Policy*. |
